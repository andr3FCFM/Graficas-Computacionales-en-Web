      ...
      E7.load("assets/GLTFmodels/Edificio_7.gltf",
          function(gltf_e7) {
              //console.log(gltg);
      ...
      E10.load("assets/GLTFmodels/Edificio_10.gltf",
          function(gltf_e10) {
              //console.log(gltg);
      ...
      E11.load("assets/GLTFmodels/Edificio_11.gltf",
          function(gltf_e11) {
              //console.log(gltg);
      ...
      Box.load("assets/GLTFmodels/Box.gltf",
          function(gltf_Box) {
              //console.log(gltg);
